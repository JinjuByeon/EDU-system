...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="headerStyle.css?v=<%=System.currentTimeMillis() %>">
    ...
    <div id="wrap">
        <header id="header">
			...
			<% if(user_name != null && request.isRequestedSessionIdValid()){ %>
                    ...
                    <li><img class="profil" src="img/img12.png"><a href=""><%=user_name%> <%=part%></a></li>
                    <li><a href="member/logout.jsp">로그아웃</a></li>

			<% }else{ %>	
						
					<li><a href=""><a href="member/login.jsp">로그인</a></li>
